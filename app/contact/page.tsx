    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="w-full bg-white py-12 sm:py-32 px-4 sm:px-6 relative overflow-hidden">
          {/* Background Pattern - hide on small screens to avoid overflow/alignment issues */}
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-black mb-6 tracking-tight">
              Get In Touch
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 font-medium uppercase tracking-widest">
              LET&apos;S WORK TOGETHER
            </p>
          </div>
        </section>
        ...
        <section className="w-full bg-gray-50 py-12 sm:py-32 px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <div className="relative bg-white border-2 border-gray-200 rounded-xl shadow-lg p-6 sm:p-12 overflow-hidden">
